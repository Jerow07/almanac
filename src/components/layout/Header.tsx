  ...
  return (
    <header ref={headerRef} className="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-pink-100/70 shadow-xs transition-all w-full max-w-full">
      <div className="max-w-7xl mx-auto px-3 sm:px-6 py-2.5 sm:py-3 w-full">
        ...
        <div className="flex items-center justify-between gap-1.5 sm:gap-3 w-full">
          ...
          <div className="flex items-center gap-2 sm:gap-2.5 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <div className="hidden sm:flex items-center gap-1 mt-0.5 text-slate-500">
                <button
                  type="button"
          ...
          <div className="flex items-center gap-1 sm:gap-2 flex-shrink-0">
            ...
            <div className="relative">
              <button
                ...
                className="p-1.5 sm:p-2 rounded-xl border border-slate-200 hover:bg-slate-50 text-slate-600 transition-all hidden sm:flex"
            ...
            <button
              ...
              className="flex items-center justify-center gap-1.5 p-2 sm:px-3.5 sm:py-2 rounded-xl bg-gradient-to-r from-pink-500 to-rose-500 hover:from-pink-600 hover:to-rose-600 text-white font-bold text-xs sm:text-sm shadow-md transition-all active:scale-95"
              title="Nueva Tarea"
            >
        ...
        <div className="flex sm:hidden items-center justify-between mt-2 pt-2 border-t border-slate-100 text-xs">
          <span className="text-[11px] font-bold text-slate-400">Este celu:</span>
          <div className="flex items-center gap-1.5">
            <button
              ...
              className={`px-2 py-0.5 rounded-lg text-[11px] font-bold transition-all flex items-center gap-1 ${
                currentUser === 'jeronimo'
                  ? 'bg-blue-600 text-white shadow-xs'
                  : 'text-blue-700 bg-blue-50/80 hover:bg-blue-100/80'
              }`}
            >
              <span>👨🏻‍💻 Jerónimo</span>
              {currentUser === 'jeronimo' && <span className="text-[9px] opacity-90">(Tú)</span>}
            ...
            <button
              ...
              className={`px-2 py-0.5 rounded-lg text-[11px] font-bold transition-all flex items-center gap-1 ${
                currentUser === 'zahria'
                  ? 'bg-pink-600 text-white shadow-xs'
                  : 'text-pink-700 bg-pink-50/80 hover:bg-pink-100/80'
              }`}
            >
              <span>👩🏻‍🎨 Zahria</span>
              {currentUser === 'zahria' && <span className="text-[9px] opacity-90">(Tú)</span>}
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-2 mt-2 sm:mt-3 pt-2 sm:pt-2.5 border-t border-slate-100">
          ...
          <div className="flex items-center bg-slate-100/90 p-1 rounded-2xl w-full sm:w-auto justify-between sm:justify-start gap-1">
            <button
              ...
              className={`flex-1 sm:flex-initial flex items-center justify-center gap-1 px-2.5 py-1 sm:px-3 sm:py-1.5 rounded-xl text-xs font-bold transition-all ${
                view === 'month'
